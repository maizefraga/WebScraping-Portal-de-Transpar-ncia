...
servidores = f"/home/maizefs/Downloads/projeto_de_pesquisa/scraping_tranparencia/camponovodoparecis/camponovodoparecis.json"
...
df_merge = pd.merge(df_servidores.T, df_alunos, how="inner",
